...
describe SearchSolrTools::Harvesters::Nmi, :skip => "Obsolete harvester, would need to be updated to new status handling method" do
  before(:each) do
  ...
  describe '#initialize' do
    it 'has a @data_centers instance variable' do
      ...
      expect(@harvester.instance_variable_get(:@data_centers)).to eql 'Norwegian Meteorological Institute'
    end

...
#
#       stub_request(:get, 'http://integration.search-solr.apps.int.nsidc.org:8983/solr/nsidc_oai/select?q=*%3A*&fq=source%3AADE&fq=spatial:[45.0,-180.0+TO+90.0,180.0]&rows=0&wt=json&indent=true&facet=true&facet.mincount=1&facet.sort=count&facet.limit=-1&facet.field=authoritative_id&facet.field=full_title&facet.field=copy_parameters&facet.field=full_platforms&facet.field=full_sensors&facet.field=full_authors')

...
describe SearchSolrTools::Errors::HarvestError do
  ...
  it 'with Harvest, Invalid Document, and Ingest errors reports all those issues' do
    status.record_status SearchSolrTools::Helpers::HarvestStatus::HARVEST_FAILURE
    status.record_status SearchSolrTools::Helpers::HarvestStatus::INGEST_ERR_INVALID_DOC
    status.record_status SearchSolrTools::Helpers::HarvestStatus::INGEST_ERR_SOLR_ERROR

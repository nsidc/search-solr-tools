...
describe AutoSuggestHarvester do
  describe 'harvest_nsidc' do
    it 'harvests from nsidc_oai and inserts into auto_suggest' do
      ...
      stub_request(:get, 'http://integration.solr-search.apps.int.nsidc.org:9283/solr/nsidc_oai/select?q=*%3A*&fq=source%3ANSIDC&rows=0&wt=json&indent=true&facet=true&facet.mincount=1&facet.sort=count&facet.limit=-1&facet.field=authoritative_id&facet.field=full_title&facet.field=copy_parameters&facet.field=full_platforms&facet.field=full_sensors&facet.field=full_authors')
      ...
      .with(body: /{"add":{"doc":{"text_suggest":.*,"source":"NSIDC","weight":.*}}}/)
      ...
      .with { |req| req.body.include?('{"add":{"doc":{"text_suggest":"AA_L2A","source":"NSIDC","weight"') }.should have_been_made

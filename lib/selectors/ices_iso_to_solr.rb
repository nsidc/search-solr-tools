...
ICES = {
  ...
  last_revision_date: {
    xpaths: ['.//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date/gmd:date/gco:DateTime', './/gmd:dateStamp/gco:DateTime'],
    multivalue: false,

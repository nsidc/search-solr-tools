...
module NsidcParameterMapping
  MAPPING = {
      ...
      '.*Aerosol.*' => 'Aerosols',
      '.*Air Temperature Reconstruction.*' => 'Air Temperature',
      ...
      '.*Fog.*' => 'Atmospheric Properties (other)',
      ...
      '.*Tropospheric Ozone.*' => 'Atmospheric Properties (other)',
      ...
      '.*(?i)(?<!marine)(?-i)Sediments.*' => 'Soil Properties (other)',
